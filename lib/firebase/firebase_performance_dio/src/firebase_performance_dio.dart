...
/// based upon [_isNavifation] field hash code which appears to be the same across
...
int? defaultResponseContentLength(Response response) {
  try {
    final String? lengthHeader = response.headers[Headers.contentLengthHeader]?.first;
