...
class SplitsInfo extends StatelessWidget {
  const SplitsInfo({super.key});

  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
          appBar:  TitleAppBar(title: StringConstants.splitInfo),
          body: Expanded(
            child: Column(
              children: [
