...
class ListedIpoItem2 extends StatefulWidget {
  const ListedIpoItem2({super.key, required this.ipo});

  final Ipos ipo;

  @override
  State<ListedIpoItem2> createState() => _ListedIpoItem2State();
}

class _ListedIpoItem2State extends State<ListedIpoItem2> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding:  EdgeInsets.symmetric(horizontal: 10.w),
                child: Text(
                    'Listed On : ${widget.ipo.listingDate}',
              ...
              Padding(
                ...
                child: Text(
                  'Listing Price : ₹${widget.ipo.listingPrice} at a ${widget.ipo.premiumOrDiscount} of ${widget.ipo.listingPercent}%',
                  style: GoogleFonts.poppins(
                      textStyle:TextStyle(
                          fontSize: 16.sp,
                          fontWeight: FontWeight.w500,
