...
class DividendInfoPage extends StatelessWidget {
  const DividendInfoPage({super.key});

  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
          appBar:  TitleAppBar(title: StringConstants.dividendInfo),
          body: Column(
            children: [
              Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                StringConstants.dividendInfoDesc,
